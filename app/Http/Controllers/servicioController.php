...
class servicioController extends Controller
{
    ...
    */
    public function getData (Request $Request)
    {
        ...
        ->addColumn('action', function ($servicio) {
            return '<a href="/servicio/'.$servicio->id.'/edit" class="btn btn-xs" title = "Editar" ><i class="glyphicon glyphicon-edit"></i></a>';
        })
        ->make(true);
    }
    ...
    */
    ...
    public function validar_servicio(Request $request){
        ...
        $servicio = servicio::select("*")->where("nombre", "=", $input["id"])->count();
